...
UNIX_APPNAME = "bcnote"
VERSION = "0.1"
APP_DESCRIPTION = "Simple Evernote client for GNU/Linux"
AUTHORS = [
    {"name": "Gwendal Le Bihan", "email": "gwendal.lebihan.dev@gmail.com"}
]
LICENSE = APPNAME + """ is free software: you can redistribute it and/or modify
it under the terms of the GNU General Public License as published by
the Free Software Foundation, either version 3 of the License, or
(at your option) any later version.
...
COPYRIGHT_NOTICE = "Copyright © 2015 Gwendal Le Bihan"
